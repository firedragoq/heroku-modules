...
# ╔══════════════════════════════════════════════════════════════╗
# ║  HerokuModUpdates — установка модулей из канала в один тап.    ║
...
@loader.tds
class HerokuModUpdatesMod(loader.Module):
    """🆕 Установка модулей из канала-витрины в один тап."""

    strings = {
        "name": "HerokuModUpdates",
        "no_bot": "🚫 <b>Укажи юзернейм бота в конфиге</b> (<code>{}cfg HerokuModUpdates</code>).",
