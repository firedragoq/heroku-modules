...
# scope: heroku_only
# requires: telethon
# changelog: премиум-эмодзи в сообщениях (готово/тегаю/стоп)
...
class DragoTagAllMod(loader.Module):
    ...
    strings = {
        "name": "DragoTagAll",
        "not_group": "<emoji document_id=5260319946633681748>🛑</emoji> <b>Команду нужно выполнять в группе.</b>",
        "running": "<emoji document_id=5258261274319432461>🔔</emoji> <b>Тегаю участников…</b> (по {n} за сообщение)",
        "done": "<emoji document_id=5258387825530807373>✅</emoji> <b>Готово.</b> Упомянул <b>{n}</b> участников.",
        "stopped": "<emoji document_id=5260319946633681748>🛑</emoji> <b>Тегание остановлено.</b>",
        "nothing": "🤷 <b>Сейчас нет активного тегания.</b>",
        "no_members": "<emoji document_id=5260319946633681748>🛑</emoji> <b>Не удалось получить участников.</b>",
